...
internal class SegmentedByteString(buffer: Buffer, byteCount: Int) : ByteString(EMPTY.data) {
  ...
  override fun substring(beginIndex: Int, endIndex: Int)
      = toByteString().substring(beginIndex, endIndex)
  ...
  override fun lastIndexOf(other: ByteArray, fromIndex: Int)
      = toByteString().lastIndexOf(other, fromIndex)
